...
import { AppFooter } from "../../../excalidraw-app/components/AppFooter";
import {
  Provider,
  useAtom,
  useAtomValue,
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        {!props.excalidraw.UIOptions?.canvasActions?.hideWelcomeScreen && (
          <AppWelcomeScreen
            onCollabDialogOpen={onCollabDialogOpen}
            isCollabEnabled={!isCollabDisabled}
          />
        ...
        {excalidrawAPI && !isCollabDisabled && (
          <Collab
            ...
            elementAuthorId={props.excalidraw.elementAuthorId}
